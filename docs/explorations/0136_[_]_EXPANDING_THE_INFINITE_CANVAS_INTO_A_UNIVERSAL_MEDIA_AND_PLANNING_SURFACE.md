...
- [x] Add export/thumbnail placeholder behavior for iframes.
...
- [x] Add collapsible branches and inherited branch styling.
...
- [x] Add freehand stroke persistence and export behavior if not already complete.
