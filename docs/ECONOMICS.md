...
([exploration 0424](./explorations/0424_[_]_THE_RUST_TEST_ASTERISK_15_AND_THE_PRICE_OF_A_REFUSAL.md)).
...
| [0424](./explorations/0424_[_]_THE_RUST_TEST_ASTERISK_15_AND_THE_PRICE_OF_A_REFUSAL.md) | The Rust test and §4a; refusals must be affordable, not just kept |
