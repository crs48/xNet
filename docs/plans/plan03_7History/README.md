...
- [Event Sourcing History Exploration](../../explorations/0008_[x]_EVENT_SOURCING_HISTORY.md) - Full research with architecture details
- [Data Model Consolidation](../plan02_1DataModelConsolidation/README.md) - NodeStore, Change<T>, LWW
- [Persistence Architecture](../../explorations/0016_[x]_PERSISTENCE_ARCHITECTURE.md) - Storage durability tiers
