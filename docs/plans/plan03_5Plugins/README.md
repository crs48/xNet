...
| 5.2  | [10-n8n-mcp-integrations.md](./10-n8n-mcp-integrations.md) | N8N community node, local REST API, MCP client | [x]    |

**Validation Gate:**

- [x] ServiceDefinition and ServiceStatus types
...
- [x] Local HTTP API server
- [x] Webhook emitter for event notifications
- [x] xNet works as MCP server (AI agents can query nodes)
- [ ] N8N community node package (separate package, lower priority)
...
- [Plugin Architecture Exploration](../../explorations/0006_[x]_PLUGIN_ARCHITECTURE.md) - Full research with prior art comparison
- [Data Model Consolidation](../plan02_1DataModelConsolidation/README.md) - Schema/Node system (plugin data model)
- [Editor Redesign Research](../../explorations/0003_[x]_EDITOR_REDESIGN_RESEARCH.md) - TipTap extension patterns
