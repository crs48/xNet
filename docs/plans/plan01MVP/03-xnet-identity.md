...
// DID operations
export { createDID, parseDID, generateIdentity, identityFromPrivateKey } from './did'

// Key management
export { deriveKeyBundle, generateKeyBundle } from './keys'

// UCAN tokens
export { createUCAN, verifyUCAN, hasCapability, type CreateUCANOptions } from './ucan'

// Passkey storage
export { type PasskeyStorage, BrowserPasskeyStorage } from './passkey'
```
