    ...
    return (
      <div className="space-y-6">
        ...
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <h3 className="text-sm font-medium mb-2">Plugin System Not Enabled</h3>
          <p className="text-xs text-muted-foreground max-w-[300px]">
            The plugin system needs to be enabled in the application configuration. Add{' '}
            <code className="bg-muted px-1 rounded">platform: 'electron'</code> to the XNetProvider
            config.
          </p>
        </div>
      </div>
