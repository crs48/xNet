...
function SocialImportJobsPanel({
  jobs
}: {
...
function JobMetric({ label, value }: { label: string; value: string }): React.ReactElement {
  return (
    <div>
...
function GraphAtlasMetric({ label, value }: { label: string; value: number }): React.ReactElement {
  return (
