...
function getNodeCard(node: CanvasNode): JSX.Element {
...
export function CanvasView({ docId }: CanvasViewProps): JSX.Element {
  ...
  return (
    <div className="flex h-full flex-1 flex-col overflow-hidden -m-6">
      ...
      <div className="relative flex-1">
        <div className="pointer-events-none absolute left-4 top-4 z-20 max-w-md rounded-full border border-border/60 bg-background/82 px-4 py-2 text-xs uppercase tracking-[0.22em] text-muted-foreground shadow-lg backdrop-blur-xl">
          {canvasHint}
        </div>
