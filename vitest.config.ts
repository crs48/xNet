    ...
    projects: [
      {
        ...
        test: {
          ...
          isolate: false,
          include: [
            'packages/{abuse,canvas-core,cli,cloud,crm,entitlements,comms,crypto,core,data,experiments,formula,history,identity,network,query,sqlite,storage,sync,telemetry,vectors}/src/**/*.test.ts',
            'packages/{abuse,canvas-core,cli,cloud,crm,entitlements,comms,crypto,core,data,experiments,formula,history,identity,network,query,sqlite,storage,sync,telemetry,vectors}/test/**/*.test.ts',
