/**
 * Social workspace seeding — deterministic saved-view seeds over the social
 * import schemas. Extracted verbatim from the (identical) web and desktop
 * `lib/social-workspace.ts` copies (exploration 0276, Theme 3).
 */
