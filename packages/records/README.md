...
Record schema, property types, and item operations for xNet.
...
```typescript
import { createDatabase, createProperty, createItem } from '@xnet/records'
...
```typescript
import { queryItems } from '@xnet/records'
