 ...
 */
// ChromePosture is canonical in @xnetjs/plugins (via ./layout-tree) — the
// local twin this file carried was the 0277 copied-type drift in miniature.
export type { ChromePosture } from './layout-tree'
