...
import { setWorkbenchHost } from '../host'
import { createTestWorkbenchHost } from '../test-platform'
...
// The panel reads author display/colors through the host adapter.
setWorkbenchHost(createTestWorkbenchHost())
