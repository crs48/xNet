...
export const builtInSchemas = {
  ...
  'xnet://xnet.fyi/RelationshipPrimitive@1.0.0': () =>
    import('./crm').then((m) => m.RelationshipPrimitiveSchema),
  'xnet://xnet.fyi/Practice@1.0.0': () => import('./crm').then((m) => m.PracticeSchema),
  ...
  'xnet://xnet.fyi/RelationshipPrimitive': () =>
    import('./crm').then((m) => m.RelationshipPrimitiveSchema),
  'xnet://xnet.fyi/Practice': () => import('./crm').then((m) => m.PracticeSchema),
