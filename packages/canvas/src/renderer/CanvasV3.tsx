...
const SELECTION_POPOVER_CAPABILITY_KEYS: Partial<
  Record<SelectionPopover, keyof CanvasSelectionCapabilities>
> = {
...
export const Canvas = forwardRef<CanvasHandle, CanvasProps>(function CanvasV3(
  ...
  useEffect(() => {
    if (!activeSelectionPopover) {
      return
    }

    const capabilityKey = SELECTION_POPOVER_CAPABILITY_KEYS[activeSelectionPopover]
    if (capabilityKey && !selectionCapabilities[capabilityKey]) {
      setActiveSelectionPopover(null)
    }
