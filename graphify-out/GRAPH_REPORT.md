...
- 2584 files · ~2,931,196 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary

- 17608 nodes · 38839 edges · 795 communities (557 shown, 238 thin omitted)
- Extraction: 98% EXTRACTED · 2% INFERRED · 0% AMBIGUOUS · INFERRED: 610 edges (avg confidence: 0.81)
- Token cost: 0 input · 0 output

## Graph Freshness

- Built from commit: `ef98835e`
...
## Communities (795 total, 238 thin omitted)

### Community 0 - "Canvas Controller Annotations Page"

Cohesion: 0.02
Nodes (214): CanvasSavedViewQueryFrameExecutor(), getCanvasQueryFrameTargets(), CanvasPerformanceSceneSeedResult, CanvasPerformanceSceneSummary, CanvasQueryFrameDefinition, CanvasQueryFrameExecutionSnapshot, CanvasQueryFrameExecutionStatus, CanvasQueryFrameFilter (+206 more)
...
Cohesion: 0.02
Nodes (147): applyCanvasFrameVariant(), CANVAS_FRAME_VARIANT_INTENTS, CANVAS_FRAME_VARIANT_VALUES, CanvasFrameLaneAxis, CanvasFrameVariantDefinition, CanvasFrameVariantNodeInput, CanvasFrameVariantProperties, createCanvasFrameVariantNode() (+139 more)
...
Cohesion: 0.03
Nodes (64): addBlocker(), CompiledFindQuery, compileFindQuery(), compileNodeQuery(), compilePage(), compilePredicate(), EMPTY_FIND_OPTIONS, schemaIdsFor() (+56 more)

### Community 11 - "Canvas Store Tile Doc"

Cohesion: 0.03
Nodes (103): getCanvasEdgeNodeIds(), createCanvasFarZoomEdgeSummaries(), createCanvasMinimapRelationshipHints(), buildCanvasPerformanceScene(), calculateBounds(), CanvasPerformanceSceneOptions, CONTENT_NODE_SEQUENCE, createCanvasPerformanceSceneDoc() (+95 more)

### Community 12 - "Data Evaluator Store Auth"

Cohesion: 0.05
Nodes (33): asNumber(), GrantExpirationCleaner, GrantExpirationCleanerOptions, GrantExpirationStore, GrantRateLimiter, GrantRateLimiterOptions, asDid(), asNumber() (+25 more)

### Community 13 - "Data System Comment Anchors"

Cohesion: 0.04
Nodes (105): createRemoteSchemaFixture(), createSchemaDefinitionNode(), TestSystemStore, Canvas, CanvasSchema, Comment, AnchorData, AnchorType (+97 more)

### Community 14 - "Data Store Node Storage"

Cohesion: 0.04
Nodes (54): hasTempIdInValue(), createNodeId(), createBatchId(), PermissionError, DeterministicNodeImportAppliedPlan, DeterministicNodeImportExecution, DeterministicNodeImportPlan, elapsedMs() (+46 more)
...
Cohesion: 0.05
Nodes (72): PerfSchema, checkbox(), CheckboxOptions, created(), CreatedOptions, createdBy(), CreatedByOptions, date() (+64 more)
...
Cohesion: 0.03
Nodes (58): HubStatusIndicator(), STATUS_CONFIG, useHubStatus(), BlobSyncProvider, aggregateConnectionStatus(), ConnectionManagerConfig, ConnectionStatus, createConnectionManager() (+50 more)
...
Cohesion: 0.05
Nodes (86): checkAndLogDeprecations(), checkDeprecations(), clearLoggedDeprecations(), configureDeprecationPolicy(), createWarning(), DEPRECATION_POLICY, DeprecationCallback, DeprecationContext (+78 more)

### Community 24 - "Data Query Ast Validate"

Cohesion: 0.05
Nodes (100): parseSavedViewDescriptorForCanvasFrame(), aggregateGroups(), aggregatePlanFor(), aggregateValue(), and(), avg(), between(), compareValues() (+92 more)
...
Cohesion: 0.04
Nodes (55): CardDetailModal(), CardDetailModalProps, getPropertyKey(), PropertyEditor(), PropertyEditorProps, DemoGridProps, boardView, cellPresences (+47 more)
...
Cohesion: 0.03
Nodes (58): ErrorBoundary, ErrorBoundaryFallbackProps, ErrorBoundaryProps, ErrorBoundaryState, OfflineIndicator(), OfflineIndicatorProps, useIsOffline(), SocialImportView() (+50 more)

### Community 32 - "Social Importers Instagram Registry"

Cohesion: 0.04
Nodes (82): claudeAdapter, mapClaudeConversations(), mapClaudeFiles(), grokAdapter, asArray(), asLabeledArray(), asRelationshipArray(), bucketPatterns (+74 more)
...
Cohesion: 0.04
Nodes (83): AccessibleButton, AccessibleButtonProps, AccessibleIconButton, AccessibleIconButtonProps, SkeletonAvatar, SkeletonAvatarProps, SkeletonButton, SkeletonButtonProps (+75 more)
...
Cohesion: 0.09
Nodes (59): createSocialNodeId(), createSourceRecord(), createStagedNode(), createCitationRecords(), mapGrokBackend(), mapGrokConversation(), mapGrokMediaPost(), mapGrokProject() (+51 more)
...
Cohesion: 0.15
Nodes (13): Core Concepts, Dual conflict resolution strategy, Authorization is encryption, xNet Documentation, Local-first React framework introduction, Task manager quickstart, Authorization Guide, Encryption is authorization (+5 more)
...
Cohesion: 0.05
Nodes (51): PresenceAvatarsProps, PresenceAvatarsProps, CommentBubble(), CommentBubbleProps, formatRelativeTime(), CommentData, CommentPopover(), CommentPopoverProps (+43 more)
...
Cohesion: 0.09
Nodes (14): QueryPageOptions, SyncStatus, createWorkerBridge(), MirrorDocEntry, UpdateBatcher, DataWorker, PoolEntry, DataWorkerAPI (+6 more)
...
Cohesion: 0.03
Nodes (99): CanvasSnapGuide, CanvasNodeComponent, CanvasNodeProps, getHandleCursor(), getHandleStyle(), getNodeAccessibleLabel(), getNodeColor(), getNodeTitle() (+91 more)
...
Cohesion: 0.05
Nodes (62): Security Vulnerability Backlog, Data Integrity Backlog, Performance Backlog, Crypto Identity Backlog, Sync Network Backlog, Schema System Backlog, React Hooks Backlog, Editor Canvas Backlog (+54 more)
...
Cohesion: 0.09
Nodes (47): coerceCellText(), CoerceResult, CopyField, FALSY, formatCellText(), parseTsv(), PasteField, serializeTsv() (+39 more)

### Community 70 - "Canvas Branches Conversion Creation"

Cohesion: 0.06
Nodes (52): BRANCH_DIRECTIONS, CanvasMindMapBranchStyle, CanvasMindMapNodePropertiesUpdate, CanvasMindMapVisibilityState, createCanvasMindMapCollapseUpdates(), createCanvasMindMapInheritedStyleMap(), createCanvasMindMapInheritedStyleUpdates(), createCanvasMindMapVisibilityState() (+44 more)
...
Cohesion: 0.06
Nodes (7): MemoryNodeStorageAdapter, MemoryNodeStorageSnapshot, TransactionTrackingMemoryNodeStorageAdapter, CountNodesOptions, NodeBatchPreflightResult, NodeChange, NodeId

### Community 78 - "React Use Node Identity"

Cohesion: 0.03
Nodes (67): DatabaseView(), DatabaseView(), Layered architecture, Write read and sync paths, CanvasDatabasePreviewSurface(), CanvasDatabasePreviewSurfaceProps, mockUseDatabase, mockUseDatabaseDoc (+59 more)

### Community 79 - "Identity Key Bundle Entry"

Cohesion: 0.07
Nodes (49): makeIdentityEvent(), makeImportEvent(), bundleCanSignAt(), bundleSecurityLevel(), bundleSize(), bundlesMatch(), createKeyBundleWithAttestation(), extractPublicKeys() (+41 more)
...
Cohesion: 0.05
Nodes (54): BottomNav(), BottomNavButton(), BottomNavButtonProps, BottomNavItem, BottomNavProps, BottomNavSpacer(), BottomNavSpacerProps, Overview (+46 more)

### Community 84 - "Data Query Sqlite Adapter"

Cohesion: 0.05
Nodes (47): InferCreateProps, compareNodeToCursor(), compareOrderValues(), decodeBase64Url(), decodeNodeQueryCursor(), encodeBase64Url(), encodeNodeQueryCursor(), extractTipTapText() (+39 more)
...
Cohesion: 0.05
Nodes (40): applyNodeQueryDescriptor(), NodeQueryDescriptor, NodeQueryParityCheckMetadata, NodeQueryResult, NodeQuerySpatialFilter, NodeQueryStorageCapabilitiesMetadata, SortDirection, withoutNodeQueryPagination() (+32 more)
...
Cohesion: 0.05
Nodes (54): DEFAULT_KEYBOARD_THRESHOLDS, deriveKeyboardState(), deriveSelectionShape(), EditorModePolicy, EditorModePolicyInput, EditorUxState, hasCommandSelection(), KeyboardState (+46 more)
...
Cohesion: 0.06
Nodes (40): EditorContentMode, KeyboardThresholds, ToolbarMode, ToolbarSurface, FloatingToolbarProps, colorFromBytes(), generateAvatarDataURI(), generatePattern() (+32 more)
...
Cohesion: 0.09
Nodes (57): Disposable, PluginNode, PluginSchema, CreateContextOptions, createExtensionContext(), ExtensionContext, PluginNodeChangeEvent, PluginNodeChangeListener (+49 more)

### Community 96 - "Sqlite Diagnostics Fts Adapter"

Cohesion: 0.07
Nodes (53): BrowserSupport, checkBrowserSupport(), checkPersistentStorage(), escapeHtml(), getPersistenceMessage(), isSafariPrivateBrowsing(), PersistentStorageRequestOptions, PersistentStorageStatus (+45 more)
...
Cohesion: 0.06
Nodes (37): CanvasPdfCollectedPageBlock, CanvasPdfCollectPagesCommand, CanvasPdfExplodePageLayout, CanvasPdfExplodePagesCommand, CanvasPdfSelectedPage, createCanvasPdfCollectPagesCommand(), CreateCanvasPdfCollectPagesCommandInput, createCanvasPdfExplodePagesCommand() (+29 more)
...
Cohesion: 0.05
Nodes (29): LoopSchema, makeDid(), EncryptionLayer, createSchema(), DID_A, DID_B, allow(), and() (+21 more)
...
Cohesion: 0.10
Nodes (25): CommandPaletteProps, iconMap, Accordion, AccordionContent, AccordionItem, AccordionProps, AccordionTrigger, Checkbox (+17 more)
...
Cohesion: 0.07
Nodes (42): CANVAS_PLUGIN_FIXTURES, CanvasPluginFixture, CanvasPluginFixtureCardSample, CanvasPluginFixtureKind, createCanvasPluginFixtureCards(), createCanvasPluginFixtureManifests(), CRM_CANVAS_PLUGIN_FIXTURE, ERP_CANVAS_PLUGIN_FIXTURE (+34 more)
...
Cohesion: 0.10
Nodes (29): getBetterSqlite3(), createExpoSQLiteAdapter(), ExpoSQLiteDatabase, ExpoSQLiteResult, ExpoSQLiteStatement, createWebSQLiteAdapter(), getDatabasePath(), isDebugEnabled() (+21 more)
...
Cohesion: 0.05
Nodes (19): CreateBridgeOptions, createDataBridge(), createMainThreadBridgeSync(), createWorkerBridgeSync(), isNodeEnvironment(), isWorkerSupported(), createNativeBridge(), isExpo() (+11 more)
...
Cohesion: 0.06
Nodes (30): BenchTaskSchema, setupBridge(), testDID, createMainThreadBridge(), MainThreadBridge, RemoteInvalidationRuntime, RemoteStreamRuntime, SyncManagerLike (+22 more)
...
Cohesion: 0.08
Nodes (16): cell(), connectCanvasNodes(), dragCanvasNode(), dragCanvasResizeHandle(), selectCanvasNode(), waitForCanvasShell(), CanvasFrameBudgetInput, CanvasPerformanceSceneInput (+8 more)
...
Cohesion: 0.06
Nodes (44): getNodeCenter(), getNodeTileId(), resolveRasterTileBounds(), CanvasObjectKind, Point, Rect, getObjectTileId(), getObjectTileIdFromRect() (+36 more)
...
Cohesion: 0.08
Nodes (34): xNet Applications, Authorization Recipes, Six-Month Strategic Roadmap, Architecture Tradeoffs, Decentralized Data Layer Vision, xNet Desktop, Block Graph Performance Research, React Hooks API Analysis (+26 more)
...
Cohesion: 0.25
Nodes (4): RelationOptions, LensRegistry, SchemaIRI, NodeStoreOptions
...
Cohesion: 0.09
Nodes (31): createMemorySQLiteAdapter(), createSeededBenchmarkStore(), addStorageTotals(), addTimingTotals(), BenchmarkError, BenchmarkOptions, BenchmarkReport, BenchmarkResult (+23 more)
...
Cohesion: 0.12
Nodes (18): applyQueryDescriptor(), createQueryDescriptor(), decodeQueryCursor(), encodeQueryCursor(), filterQueryNodes(), matchesQueryDescriptor(), normalizeQueryExecutionMode(), normalizeQuerySourcePreference() (+10 more)

### Community 262 - "Sync Yjs Limits Rate"

Cohesion: 0.08
Nodes (20): getEnvelope(), hasPeerId(), isSyncMessage(), RelayService, toBase64(), reportRemoteMutationRejection(), calculateChunkCount(), chunkUpdate() (+12 more)
...
Cohesion: 0.09
Nodes (19): imageRef, pdfRef, ResizeObserverStub, resolveUrl, GridCell, GridCellInner(), GridCellProps, seedValue() (+11 more)
...
Cohesion: 0.19
Nodes (13): NodeStoreContextValue, useUndoScope(), UseUndoScopeOptions, UseUndoScopeResult, XNetInternalContextValue, InstrumentationContext, InstrumentationContextValue, QueryTrackerLike (+5 more)
...
Cohesion: 0.16
Nodes (21): createIdentity(), setup(), createIdentity(), createTestStore(), createTestStore(), createTestStore(), createTestStore(), makeIdentity() (+13 more)
...
Cohesion: 0.20
Nodes (10): Infinite Canvas Guide, Four-layer extensibility system, Plugin middleware system, Plugin Development Guide, @xnetjs/plugins initial publish metadata, Canvas plugin contributions, ExtensionContext, Plugin registry (+2 more)
...
Cohesion: 0.17
Nodes (12): Lower packages cannot import higher packages, Package Graph, BLAKE3 integrity, Hybrid classical post-quantum cryptography stack, Security levels, XChaCha20-Poly1305 encryption, Monorepo development workflow, SignedYjsEnvelope (+4 more)
...
Cohesion: 0.22
Nodes (9): Understanding xNet for AI Assistants, No-backend AI assistance model, CRDTs, Local-First, Offline-first local data model, Offline Support, LLM docs index, AI no-backend mental model (+1 more)
...
Cohesion: 0.25
Nodes (8): xNet AI Surface Contract, Rich Text Editor Redesign, Plugin Architecture, Durable Storage Architecture, Regenerative Farming ERP Plugin, Off-Main-Thread DataBridge Architecture, AI-Collaborative Editing, Plugin Marketplace
...
Cohesion: 0.25
Nodes (8): Hub Setup, Caddy reverse proxy for Hub, Hub Docker Compose deployment, Backup query and federation services, xNet Hub server, WebSocket sync relay, UCAN authentication and rate limiting, @xnetjs/hub

### Community 430 - "History Engine Site Versioning"

Cohesion: 0.25
Nodes (8): Schema lenses, Translate-on-read compatibility, Version Compatibility, @xnetjs/history initial publish metadata, Audit and time travel, Change-chain verification, HistoryEngine, @xnetjs/history
...
Cohesion: 0.29
Nodes (7): Custom sync protocol, Network and Transport, Network security stack, libp2p WebRTC networking, Peer scoring telemetry, Network security suite, @xnetjs/network
...
Cohesion: 0.29
Nodes (7): Column UI E2E harness, Database E2E harness, xNet E2E test harness, Database view components, Property renderers, View registry, @xnetjs/views
...
Cohesion: 0.22
Nodes (9): Multiplexed WebSocket decision, Background Sync Manager, NodePool Registry OfflineQueue, Sync Architecture, SyncManager, Electron BSM process split, Electron Setup, Sync Guide (+1 more)
...
Cohesion: 0.22
Nodes (9): Data Model, Schema node change model, defineSchema, Schema IRI, Yjs document option, Schema source of truth, Schemas Overview, InferCreateProps and FlatNode pipeline (+1 more)

### Community 476 - "Web Social Workspace Get"

Cohesion: 0.29
Nodes (8): Architecture Decisions, Field-level LWW decision, One-way MetaBridge decision, Yjs over Automerge, Dual CRDT model, Strong eventual consistency, useNode dual-write model, Lamport clocks
...
Cohesion: 0.40
Nodes (5): 15-panel debug suite, DevTools event bus, Runtime diagnostics, @xnetjs/devtools, DevTools Guide
...
Cohesion: 0.25
Nodes (8): Hooks Overview, XNetProvider context requirement, @xnetjs/react initial publish metadata, React core hooks, Materialized views, Remote and stream queries, XNetProvider, @xnetjs/react
...
Cohesion: 0.40
Nodes (5): @xnetjs/sqlite initial publish metadata, FTS5 helpers, Unified SQLite schema tables, Unified SQLite adapter, @xnetjs/sqlite
...
Cohesion: 0.40
Nodes (5): @xnetjs/storage initial publish metadata, Content-addressed blob store, Chunk manager, Storage telemetry integration, @xnetjs/storage
...
Cohesion: 0.50
Nodes (4): Canonical social schemas, Graph lenses and canvas projection, Social graph import flow, @xnetjs/social
...
Cohesion: 0.50
Nodes (4): P2P telemetry sync, Data scrubbing and bucketing, Tiered consent, @xnetjs/telemetry

### Community 509 - "Vectors Xnetjs Embedding Model"

Cohesion: 0.50
Nodes (4): Embedding model, HNSW vector index, Hybrid search, @xnetjs/vectors
...
Cohesion: 0.67
Nodes (3): Design tokens, Invisible Design principle, xNet Design System

### Community 514 - "Docs X Demo Hub"

Cohesion: 0.67
Nodes (3): Railway Hub Deployment, GitHub Pages Web App, Railway Demo Hub
...
Cohesion: 0.67
Nodes (3): Formula language, Formula lexer parser evaluator pipeline, @xnetjs/formula
...
Cohesion: 0.29
Nodes (7): DID:key and UCAN identity model, Identity Model, @xnetjs/identity initial publish metadata, Key bundles, Passkey storage, UCAN tokens, @xnetjs/identity

### Community 782 - "Community 782"

Cohesion: 0.40
Nodes (6): Editor extensions, RichTextEditor, TipTap and Yjs collaboration, @xnetjs/editor, Collaboration Guide, Rich Text Editor Guide
...
- **3513 isolated node(s):** `Usage`, `What graphify is for`, `Step 0 - GitHub repos and multi-path merge (only if a URL or several paths)`, `Step 1 - Ensure graphify is installed`, `Step 2 - Detect files` (+3508 more)
...
- **Why does `Listener` connect `React Use Auth Hooks` to `Canvas Node Edge Position`, `Plugins Process Manager Managed`, `React Use Page Task`, `Views Builtins Registry View`, `Sync Features Provider Base`, `Plugins Registry Plugin Manifest`, `Sqlite Browser Support Request`, `Electron Data Process Manager`, `Views Property Handler Editor`, `Plugins Contributions Typed Registry`, `Identity Key Bundle Entry`, `Data Store Node Storage`, `Telemetry Manager Tier Consent`, `Sync Change Telemetry Manager`, `Electron Cloudflare Tunnel Manager`?**
  _High betweenness centrality (0.119) - this node is a cross-community bridge._
- **Why does `cn()` connect `Ui Component Catalog Stories` to `Views View Config Use`, `Editor Task View Embed`, `React Package Core Import`, `Views Use Gallery State`, `Community 783`, `Views Grid Stories Model`, `Editor React Canvas External`, `Editor Markdown Xnet Database`, `Editor Items Slash Command`, `Views Database Surface Stories`, `Views Use Calendar State`, `Ui Menu Electron System`, `Views Grid Peek File`, `Ui Responsive Sidebar Contrast`, `Ui Comments Catalog Stories`, `Editor Rich Text Ux`, `Canvas Core Interest Tiles`, `Ui Date Picker Accessible`, `Ui Responsive Dialog Modal`, `Views Builtins Registry View`, `Views Grid Surface State`, `Editor Rich Text Stories`, `Electron App Settings View`, `Ui Cn Devtools Catalog`, `Editor Floating Toolbar Shortcuts`, `Editor File Extension Drop`, `Editor Mermaid Extension Node`, `Editor Task Mention Extension`, `Views Add Column Modal`, `Ui Settings View Stories`, `Editor Callout Extension Node`, `Editor Blob Context Image`, `Views Use Timeline State`, `Canvas Use Comments Comment`, `Social Graph Lenses Data`, `Ui Primitive Catalog Stories`, `Editor Drag Drop Plugin`?**
...
- **What connects `Usage`, `What graphify is for`, `Step 0 - GitHub repos and multi-path merge (only if a URL or several paths)` to the rest of the system?**
  _3541 weakly-connected nodes found - possible documentation gaps or missing edges._
- **Should `Canvas Controller Annotations Page` be split into smaller, more focused modules?**
  _Cohesion score 0.018473212069637982 - nodes in this community are weakly interconnected._
- **Should `Canvas Node Edge Position` be split into smaller, more focused modules?**
  _Cohesion score 0.01962384790667619 - nodes in this community are weakly interconnected._
- **Should `Canvas V2Legacy Viewport Node` be split into smaller, more focused modules?**
  _Cohesion score 0.020884093282283328 - nodes in this community are weakly interconnected._
