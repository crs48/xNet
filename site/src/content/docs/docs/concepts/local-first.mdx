...
- [CRDTs](/xNet/docs/concepts/crdts/) — How conflict-free data types work
- [Sync Architecture](/xNet/docs/concepts/sync-architecture/) — How xNet syncs peer-to-peer
- [Offline Patterns](/xNet/docs/guides/offline/) — Building resilient offline UIs
