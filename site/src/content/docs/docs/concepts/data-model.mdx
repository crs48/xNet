...
See [Property Types](/xNet/docs/schemas/property-types/) for full details on each type.
...
- [defineSchema](/xNet/docs/schemas/defineschema/) — Schema definition API
- [Property Types](/xNet/docs/schemas/property-types/) — All 16 property types
- [Type Inference](/xNet/docs/schemas/type-inference/) — How TypeScript types flow from schemas to hooks
