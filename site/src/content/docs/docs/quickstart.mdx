...
<Tabs>
  <TabItem label="Add rich text">
    Use [`useNode`](/xNet/docs/hooks/usenode/) to add a collaborative rich text editor to each task:
    ```tsx
  ...
  <TabItem label="Learn more">
    - [Core Concepts](/xNet/docs/core-concepts/) — understand the mental model
    - [useQuery reference](/xNet/docs/hooks/usequery/) — filtering, sorting, pagination
    - [defineSchema reference](/xNet/docs/schemas/defineschema/) — all schema options
    - [Property Types](/xNet/docs/schemas/property-types/) — all 16 property types
  </TabItem>
</Tabs>
