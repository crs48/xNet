...
| Hook                                       | Purpose                                                |
| ------------------------------------------ | ------------------------------------------------------ |
| [`useQuery`](/xNet/docs/hooks/usequery/)   | Read data reactively. Filter, sort, paginate.          |
| [`useMutate`](/xNet/docs/hooks/usemutate/) | Create, update, delete with full type safety.          |
| [`useNode`](/xNet/docs/hooks/usenode/)     | Open a single node for collaborative editing with Yjs. |
