...
- [`useQuery`](/xNet/docs/hooks/usequery/) — read the data you mutate
- [`useNode`](/xNet/docs/hooks/usenode/) — alternative for single-node editing with Yjs
- [`defineSchema`](/xNet/docs/schemas/defineschema/) — define the schemas you write to
