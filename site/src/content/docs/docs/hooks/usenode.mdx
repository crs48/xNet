...
- [`useQuery`](/xNet/docs/hooks/usequery/) — for reading multiple nodes (no Yjs)
- [`useMutate`](/xNet/docs/hooks/usemutate/) — for mutations without a Yjs document
- [`useIdentity`](/xNet/docs/hooks/useidentity/) — get the current DID for presence
- [Collaboration guide](/xNet/docs/guides/collaboration/) — full walkthrough of building a collaborative editor
