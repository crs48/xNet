...
<CardGrid>
  <LinkCard
    ...
    description="npx @xnetjs/cli connect claude-code — read, query, and edit your workspace from Claude Code or Codex."
    href="/docs/guides/coding-agents/"
  />
  <LinkCard
    title="Build with React"
    description="Three hooks replace your entire backend. Build a task manager in 5 minutes."
...
<CardGrid>
  ...
  <LinkCard
    ...
    description="The files-first agent surface: checkouts, the xnet CLI, SKILL.md, slim MCP."
    href="/docs/guides/agent-interfaces/"
  />
  <LinkCard
    title="The Protocol"
