...
draft: false
description: All 16 property types available in xNet schemas.
sidebar:
  badge:
    text: Core
    variant: success
...
See [Relations](/xNet/docs/schemas/relations/) for patterns and temp ID resolution in transactions.
...
- [`defineSchema`](/xNet/docs/schemas/defineschema/) — using these types in a schema
- [Relations](/xNet/docs/schemas/relations/) — patterns for linking nodes
- [Type Inference](/xNet/docs/schemas/type-inference/) — how types flow to hooks
