...
| `document`   | `'yjs' \| 'automerge'`            | No       | CRDT document type. Required for [`useNode`](/xNet/docs/hooks/usenode/) rich text. |
...
Add `document: 'yjs'` to enable collaborative editing via [`useNode`](/xNet/docs/hooks/usenode/):
...
- [Property Types](/xNet/docs/schemas/property-types/) — all 16 property builders
- [Relations](/xNet/docs/schemas/relations/) — linking nodes together
- [Type Inference](/xNet/docs/schemas/type-inference/) — how TypeScript types flow
