...
| `document`   | `'yjs' \| 'automerge'`            | No       | CRDT document type. Required for [`useNode`](/xNet/hooks/usenode/) rich text. |
...
Add `document: 'yjs'` to enable collaborative editing via [`useNode`](/xNet/hooks/usenode/):
...
- [Property Types](/xNet/schemas/property-types/) — all 16 property builders
- [Relations](/xNet/schemas/relations/) — linking nodes together
- [Type Inference](/xNet/schemas/type-inference/) — how TypeScript types flow
