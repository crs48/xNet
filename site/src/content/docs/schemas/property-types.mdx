...
See [Relations](/xNet/schemas/relations/) for patterns and temp ID resolution in transactions.
...
- [`defineSchema`](/xNet/schemas/defineschema/) — using these types in a schema
- [Relations](/xNet/schemas/relations/) — patterns for linking nodes
- [Type Inference](/xNet/schemas/type-inference/) — how types flow to hooks
