...
| --------- | ------------------ | --------------------------------------------------------------------------------------- |
| `schema`  | `DefinedSchema<P>` | The schema to query. Created with [`defineSchema()`](/xNet/schemas/defineschema/). |
...
- [`useMutate`](/xNet/hooks/usemutate/) — write data that `useQuery` reads
- [`useNode`](/xNet/hooks/usenode/) — when you need a Yjs document for one node
- [`defineSchema`](/xNet/schemas/defineschema/) — define the schemas you query
