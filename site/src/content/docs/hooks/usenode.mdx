...
- [`useQuery`](/xNet/hooks/usequery/) — for reading multiple nodes (no Yjs)
- [`useMutate`](/xNet/hooks/usemutate/) — for mutations without a Yjs document
- [`useIdentity`](/xNet/hooks/useidentity/) — get the current DID for presence
- [Collaboration guide](/xNet/guides/collaboration/) — full walkthrough of building a collaborative editor
