...
<Tabs>
  <TabItem label="Add rich text">
    Use [`useNode`](/xNet/hooks/usenode/) to add a collaborative rich text editor to each task:
    ```tsx
  ...
  <TabItem label="Learn more">
    - [Core Concepts](/xNet/core-concepts/) — understand the mental model
    - [useQuery reference](/xNet/hooks/usequery/) — filtering, sorting, pagination
    - [defineSchema reference](/xNet/schemas/defineschema/) — all schema options
