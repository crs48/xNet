...
- [Identity Model](/xNet/concepts/identity-model/) — How keys become identities
- [Identity & Keys Guide](/xNet/guides/identity/) — Practical crypto API usage
- [Sync Guide](/xNet/guides/sync/) — How signatures protect sync
