...
- [Sync Guide](/xNet/guides/sync/) — Configuration, debugging, and API
- [CRDTs](/xNet/concepts/crdts/) — How conflict-free merging works
- [Cryptography](/xNet/concepts/cryptography/) — The primitives behind signatures
- [Electron Setup](/xNet/guides/electron/) — The BSM architecture in detail
