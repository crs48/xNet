...
- [CRDTs](/xNet/concepts/crdts/) — How conflict-free data types work
- [Sync Architecture](/xNet/concepts/sync-architecture/) — How xNet syncs peer-to-peer
- [Offline Patterns](/xNet/guides/offline/) — Building resilient offline UIs
